...
export const DISEASES: DiseaseInfo[] = [
  ...
  },
  {
    ...
    categoria: "Hongo",
    estado: "Infectada",
    afecta_a: ["Manzana", "Cedro Rojo Oriental (Juniperus virginiana)"],
  ...
  },
  {
    ...
    categoria: "Complejo fúngico", // Falls under string
    estado: "Infectada",
    afecta_a: ["Uva"],
    nivel_severidad: "Alta",
  ...
  },
  {
    ...
    categoria: "Bacteria",
    estado: "Infectada",
    afecta_a: ["Naranja", "Limón", "Mandarina", "Pomelo", "Otros cítricos"],
    nivel_severidad: "Alta",
  ...
  },
  {
    ...
    categoria: "Bacteria",
    estado: "Infectada",
    afecta_a: ["Durazno", "Nectarina", "Ciruela", "Albaricoque"],
    nivel_severidad: "Media a Alta",
  ...
  },
  {
    ...
    categoria: "Hongo",
    estado: "Infectada",
    afecta_a: ["Papa", "Tomate", "Otras solanáceas"],
    nivel_severidad: "Media",
  ...
  },
  {
    ...
    categoria: "Oomiceto", // Falls under string
    estado: "Infectada",
    afecta_a: ["Papa", "Tomate"],
    nivel_severidad: "Alta",
  ...
  },
  {
    ...
    categoria: "Hongo",
    estado: "Infectada",
    afecta_a: ["Calabaza", "Zapallo", "Pepino", "Melón", "Sandía", "Otras cucurbitáceas"],
    nivel_severidad: "Media a Alta",
  ...
  },
  {
    ...
    categoria: "Hongo",
    estado: "Infectada",
    afecta_a: ["Tomate", "Otras solanáceas"],
    nivel_severidad: "Media",
  ...
  },
  {
    ...
    categoria: "Ácaro",
    estado: "Infestada",
    afecta_a: ["Tomate", "Muchas otras hortalizas, frutales y ornamentales"],
    nivel_severidad: "Media a Alta",
  ...
  },
  {
    ...
    categoria: "Hongo",
    estado: "Infectada",
    afecta_a: ["Tomate", "Pepino", "Papaya", "Otras plantas"],
    nivel_severidad: "Media",
  ...
  },
  {
    ...
    categoria: "Virus",
    estado: "Infectada",
    afecta_a: ["Tomate", "Algunas otras solanáceas"],
    nivel_severidad: "Alta",
  ...
  },
  {
    ...
    categoria: "Virus",
    estado: "Infectada",
    afecta_a: ["Tomate", "Pimiento", "Tabaco", "Muchas otras solanáceas y no solanáceas"],
    nivel_severidad: "Media",
